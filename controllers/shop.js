...
//     const storageFile = bucket.file('documents/test1.txt');
// storageFile
//   .exists()
//   .then(() => {
...
const getAllItems = async (req, res, next) => {
    try {
        ...
        const data1 = await categories.get();
        const catArray = []
...
const getCheckout = async(req, res, next) => {
    ...
    res.render('shop/checkout', { cart: Cart.getCart(), pageTitle: 'Shopping Cart Detail', path: '/cart', name: 'Edward' })
};
